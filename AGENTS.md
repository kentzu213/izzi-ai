...
This project is indexed by GitNexus as **Tool Starizzi - B2C - Openclaw** (972 symbols, 2616 relationships, 79 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/Tool Starizzi - B2C - Openclaw/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/Tool Starizzi - B2C - Openclaw/context` | Codebase overview, check index freshness |
| `gitnexus://repo/Tool Starizzi - B2C - Openclaw/clusters` | All functional areas |
| `gitnexus://repo/Tool Starizzi - B2C - Openclaw/processes` | All execution flows |
| `gitnexus://repo/Tool Starizzi - B2C - Openclaw/process/{name}` | Step-by-step execution trace |
