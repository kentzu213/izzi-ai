...
const FALLBACK_EXTENSIONS = [
  ...
  {
    id: 'ext-github-trending-fb',
    name: 'github-trending-fb',
    display_name: 'GitHub Trending → FB Group + Blog',
    description: 'GitHub trending → ChatGPT viết bài → ảnh → blog izziapi → đăng Facebook group → comment blog. Cài Playwright mặc định; tuỳ chỉnh tài khoản Facebook (profile) + khung giờ. Windows + macOS.',
    version: '1.0.0',
    category: 'Marketing',
    rating_avg: 4.8,
    install_count: 1200,
  ...
  },
  {
    ...
    description: 'Tạo bản nghe thử TTS tiếng Việt/Anh cục bộ bằng VieNeu-TTS. Chỉ dùng giọng dựng sẵn đã kiểm định; không clone giọng và không có hosted fallback.',
    version: '0.2.0',
    category: 'Voice',
    rating_avg: 4.7,
    install_count: 3100,
