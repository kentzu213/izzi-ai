...
// Secret names are written to a host-managed .env and then used while
// launching Docker Compose. These names either control the host/Compose client
// or are required to launch the child process, so extensions cannot claim them.
