...
const DEMO_EXTENSIONS: MarketplaceExtension[] = [
  ...
  { id: 'ext-voice-studio', name: 'voice-studio', displayName: 'Voice Studio (VieNeu-TTS)', description: 'Tạo bản nghe thử TTS tiếng Việt/Anh cục bộ bằng VieNeu-TTS. Chỉ khởi động khi người dùng yêu cầu; không có hosted fallback.', author: 'Izzi AI', version: '0.1.0', category: 'Voice', rating: 4.7, installs: 3100, price: null, icon: '🗣️' },
