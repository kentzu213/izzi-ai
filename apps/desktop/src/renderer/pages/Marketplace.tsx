...
const DEMO_EXTENSIONS: MarketplaceExtension[] = [
  ...
  { id: 'ext-voice-studio', name: 'voice-studio', displayName: 'Voice Studio (VieNeu-TTS)', description: 'TTS + clone giọng tiếng Việt/Anh chạy CỤC BỘ (VieNeu-TTS, CPU/ONNX, offline). Mở tiện ích là tự khởi động backend localhost. Nâng cấp cho OmniVoice.', author: 'Izzi AI', version: '0.1.0', category: 'Voice', rating: 4.7, installs: 3100, price: null, icon: '🗣️' },
