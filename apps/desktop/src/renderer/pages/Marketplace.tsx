...
const DEMO_EXTENSIONS: MarketplaceExtension[] = [
  ...
  { id: 'ext-chat-quality', name: 'chat-quality-agent', displayName: 'Chat Quality Agent (CSKH)', description: 'Đồng bộ Zalo OA & Facebook Messenger, dùng AI chấm điểm chất lượng chăm sóc khách hàng (Đạt/Không đạt, 0-100), phân loại chat, cảnh báo Telegram/Email.', author: 'Izzi AI', version: '1.0.0', category: 'Customer Support', rating: 4.6, installs: 2100, price: { monthly: 12.99, yearly: 129 }, icon: '📞' },
  { id: 'ext-toonflow', name: 'toonflow-studio', displayName: 'Toonflow Studio', description: 'Biến tiểu thuyết/truyện thành kịch bản → phân cảnh → ảnh → video ngắn (short drama) trên canvas vô hạn. Đa AI provider (Sora / Nano Banana / Seedance).', author: 'Izzi AI', version: '1.0.0', category: 'Video', rating: 4.7, installs: 3400, price: { monthly: 24.99, yearly: 249 }, icon: '🎬' },
  { id: 'ext-omnivoice', name: 'omnivoice-tts', displayName: 'OmniVoice TTS', description: 'Text-to-speech + voice cloning đa ngôn ngữ, chạy cục bộ. Tạo sách nói / lồng tiếng từ văn bản.', author: 'Izzi AI', version: '1.0.0', category: 'Voice', rating: 4.5, installs: 1800, price: null, icon: '🎙️' },
  { id: 'ext-html-video', name: 'html-to-video', displayName: 'HTML to Video', description: 'Render HTML/template thành video bằng Playwright — lớp "HTML→Video" cho coding agent. Không phụ thuộc token bên thứ ba.', author: 'Izzi AI', version: '0.1.0', category: 'Video', rating: 4.3, installs: 900, price: null, icon: '🎞️' },
  ...
  { id: 'ext-ai-video-studio', name: 'ai-video-studio', displayName: 'AI Video Studio', description: 'Tạo video AI (text/image→video) điều khiển Veo/Grok/SORA. Lưu ý: nên dùng nguồn hợp lệ (model open-weight hoặc API chính thức) thay vì tự động hoá API nội bộ.', author: 'Izzi AI', version: '0.1.0', category: 'Video', rating: 4.2, installs: 1500, price: { monthly: 29.99, yearly: 299 }, icon: '📹' },
  ...
  { id: 'ext-quickmagic', name: 'quick-magic', displayName: 'Quick Magic', description: 'Tải & chuyển đổi video từ URL (yt-dlp + ffmpeg), gói gọn trong app desktop.', author: 'Izzi AI', version: '1.0.0', category: 'Video', rating: 4.4, installs: 5100, price: null, icon: '⬇️' },
  ...
  { id: 'ext-voice-studio', name: 'voice-studio', displayName: 'Voice Studio (VieNeu-TTS)', description: 'Tạo bản nghe thử TTS tiếng Việt/Anh cục bộ bằng VieNeu-TTS. Chỉ dùng giọng dựng sẵn đã kiểm định; không clone giọng và không có hosted fallback.', author: 'Izzi AI', version: '0.2.0', category: 'Voice', rating: 4.7, installs: 3100, price: null, icon: '🗣️' },
